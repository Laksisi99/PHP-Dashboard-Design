...
<div class="card shadow mb-0">
  <div class="card-header py-3">
    ...
    <h6 class="ml-6 mt-3  font-weight-bold text-primary">Remove User </h6>
  ...
  <div class="card-body">
      ...
      <form action="codeclub.php" method="POST"><div class="form-group">
      <div class="form-group">
            <label>User ID</label>
            <input type="text" name="new_user_id" class="form-control" placeholder="Enter Admin ID">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="password" name="delete_confirmpassword" class="form-control" placeholder="Retype Current Password">
        </div>
      </form>
